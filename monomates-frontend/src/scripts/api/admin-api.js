...
export const getAdminDevices = () => apiRequest("/admin/devices");
export const updateAdminDeviceConnection = (binId, connection) => apiRequest(`/admin/devices/${encodeURIComponent(binId)}/connection`, { method: "PATCH", body: connection });
